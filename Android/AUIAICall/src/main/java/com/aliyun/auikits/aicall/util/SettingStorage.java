...
public class SettingStorage {
    ...
    public static final String KEY_BOOT_AICALL_ENGINE_SINGLETON_SWITCH = "KEY_BOOT_AICALL_ENGINE_SINGLETON_SWITCH";
    public static final String KEY_BOOT_AUIDO_ELARY_START = "KEY_BOOT_AUIDO_ELARY_START";
    public static final String KEY_BOOT_ENABLE_AUIDO_PROFILE_DEFAULT = "KEY_BOOT_ENABLE_AUIDO_PROFILE_DEFAULT";
    public static final String KEY_BOOT_ENABLE_CLIENT_AUDIO_PLAY_WELCOME = "KEY_BOOT_ENABLE_CLIENT_AUDIO_PLAY_WELCOME";

    public static final String KEY_ENABLE_VOICE_INTERRUPT = "KEY_ENABLE_VOICE_INTERRUPT";
    public static final String KEY_BOOT_ENABLE_HISTORY_SYNC_WITH_TTS = "KEY_BOOT_ENABLE_HISTORY_SYNC_WITH_TTS";
