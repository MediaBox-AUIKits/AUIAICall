...
- Configure the agent ID and region. Edit the configuration file `AUIAICall/src/main/assets/AgentConfig/agent_scenes.json`, modify the `agent_id` in each scene to the agent ID you created in the console, and confirm that the `region` configuration is correct
```json
// agent_scenes.json example
{
  "version": 1,
  "agents": [
    {
      "agent_type": "VoiceAgent",  // Voice call
      "scenes": [
        {
          "agent_id": "Your voice call agent ID",
          "region": "cn-shanghai",
    ...
    {
      "agent_type": "AvatarAgent",  // Digital human
      "scenes": [
        {
          "agent_id": "Your digital human agent ID",
          "region": "cn-shanghai",
          "title": "Digital Human Call"
        }
      ]
    },
    {
      "agent_type": "VisionAgent",  // Vision understanding
      "scenes": [
        {
          "agent_id": "Your vision understanding agent ID",
          "region": "cn-shanghai",
    ...
    {
      "agent_type": "VideoAgent",  // Video call
      "scenes": [
        {
          "agent_id": "Your video call agent ID",
          "region": "cn-shanghai",
          "title": "Video Call"
        }
      ]
    ...
    {
      "agent_type": "ChatAgent",  // Message conversation
      "scenes": [
        {
          "agent_id": "Your chatbot agent ID",
          "region": "cn-shanghai",
...
dependencies {
    ...
    implementation 'com.aliyun.aio:AliVCSDK_ARTC:7.10.0'                  // Modify x.x.x to the version compatible with your project
...
- Configure the agent ID and region. Edit the configuration file `AUIAICall/src/main/assets/AgentConfig/agent_scenes.json`, modify the `agent_id` in each scene to the agent ID you created in the console, and confirm that the `region` configuration is correct
```json
// agent_scenes.json configuration instructions
// Supported agent_type types:
// - VoiceAgent: Voice call
// - AvatarAgent: Digital human
// - VisionAgent: Vision understanding
// - VideoAgent: Video call
// - ChatAgent: Message conversation
// - PSTNInboundAgent: PSTN inbound call
// - PSTNOutboundAgent: PSTN outbound call
//
// Multiple scenes can be configured under each agent_type
// agent_id: Agent ID generated by the console
// region: Agent region, such as cn-shanghai, cn-beijing, etc.
```
