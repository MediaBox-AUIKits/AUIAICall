...
- 配置智能体Id及所在区域，编辑配置文件 `AUIAICall/src/main/assets/AgentConfig/agent_scenes.json`，将各场景中的 `agent_id` 修改为你在控制台创建的智能体ID，同时确认 `region` 区域配置是否正确
```json
// agent_scenes.json 示例
{
  "version": 1,
  "agents": [
    {
      "agent_type": "VoiceAgent",  // 语音通话
      "scenes": [
        {
          "agent_id": "你的语音通话智能体ID",
          "region": "cn-shanghai",
          "title": "智能客服"
        }
      ]
    ...
    {
      "agent_type": "VisionAgent",  // 视觉理解
      "scenes": [
        {
          "agent_id": "你的视觉理解智能体ID",
          "region": "cn-shanghai",
          "title": "视觉理解"
        }
      ]
    ...
    {
      "agent_type": "VideoAgent",  // 视频通话
      "scenes": [
        {
          "agent_id": "你的视频通话智能体ID",
          "region": "cn-shanghai",
          "title": "视频通话"
        }
      ]
    ...
    {
      "agent_type": "ChatAgent",  // 消息对话
      "scenes": [
        {
          "agent_id": "你的聊天机器人智能体ID",
          "region": "cn-shanghai",
          "title": "消息对话"
        }
      ]
...
dependencies {
    ...
    implementation 'com.aliyun.aio:AliVCSDK_ARTC:7.10.0'                  //修改x.x.x为你工程适配的版本
...
// - VideoAgent: 视频通话
// - ChatAgent: 消息对话
// - PSTNInboundAgent: 电话呼入
// - PSTNOutboundAgent: 电话呼出
//
// 每个 agent_type 下可以配置多个 scenes(场景)
// agent_id: 控制台生成的智能体ID
// region: 智能体所在区域，如 cn-shanghai、cn-beijing 等
```
