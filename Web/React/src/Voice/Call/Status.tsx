...
import { AICallAgentState } from '../../aiCall/type';
...
const AgentStateClassMap = {
  ...
  [AICallAgentState.Talking]: '_is-talking',
};
  ...
  return (
    <div className='voice-call-status'>
      <div className='_box'>
        ...
        <div
          className={`voice-user-status ${
            isSpeaking && agentState === AICallAgentState.Listening ? '_is-talking' : ''
          }`}
        >
          <div></div>
          <div></div>
